...
showCharactersButton.style.backgroundColor = "#234a72e7"
...
function renderCharacters(){
    ...
    if(renderStatus){
        showInfo.innerHTML = characters.map(function(characters){
            return(`
            <div class="col-lg-3 col-md-6 col-sm12 card">
            <img src="${characters.pic}">
            <h2>${characters.name}</h2>
            <h3>Homeworld: ${characters.homeworld || "Unknown"}</h3>
            </div>
            `)

        }).join("")
        showCharactersButton.textContent = "Karakterleri Gizle"
        showCharactersButton.style.backgroundColor = "#0aede5"
    } else{
        showInfo.innerHTML = ""
